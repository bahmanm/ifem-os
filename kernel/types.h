...
/*
 * Defines types that are merely used in kernel.
 */
#ifndef KERNEL__TYPES_H
#define KERNEL__TYPES_H
...
typedef int (*irq_handler_t)(int irq);	/* irq handler function prototype */

#endif /* KERNEL__TYPES_H */
